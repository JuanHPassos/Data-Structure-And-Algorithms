/*
Construa a implementação da estrutura de dados DEQUE, utilizando a interface fornecida abaixo, 
implementando todas as funções descritas.
*/
...
ITEM* deque_remover_inicio(DEQUE* deque){
    if(!deque_vazia(deque)){
        ...
        deque->inicio = (deque->inicio + 1)%5000;
